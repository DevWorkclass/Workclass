...
export function LoginAnimation() {
  return (
    <div className="relative hidden w-full overflow-hidden bg-brand-navy lg:flex lg:flex-col lg:justify-between lg:p-12">
      ...
      <div className="bg-brand-red/20 absolute -bottom-1/4 -right-1/4 size-[600px] rounded-full blur-[100px]" />
        ...
        <div className="relative size-64 xl:size-80">
          ...
          >
            ...
            <div className="mt-auto pt-16">
              <div className="bg-brand-red/50 size-8 rounded" />
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-center gap-3">
              <div className="size-10 rounded-full bg-brand-navy/50" />
