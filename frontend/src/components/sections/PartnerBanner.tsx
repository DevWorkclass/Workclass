...
export function PartnerBanner() {
  return (
    <section className="container py-10">
      <div className="flex flex-col items-start justify-between gap-4 rounded-2xl border border-brand-gold/30 bg-gradient-to-r from-brand-gold/15 to-transparent px-6 py-6 sm:flex-row sm:items-center">
        <div>
